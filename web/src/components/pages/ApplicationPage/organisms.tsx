...
export function ContactForm({action = "contact.php", method = "post"}) {
    ...
    return <form onSubmit={handleFormSubmit} className="w-full px-4">
        ...
        <button className="w-full py-4 text-center bg-brand-secondary-blue rounded text-white uppercase my-2"
                type="submit">send
        </button>
    </form>
}
    ...
    return (
        <footer className="relative top-16 py-4 w-full bg-black text-white">
            ...
            <ul className="px-4 mb-4">
                <li className="mb-2 leading-6 tracking-wide"><i className=""/>Suite 8, Q-Kon Building, 8 Pieter
                    Str, <br/> Highveld Techno Park,<br/> Centurion
                </li>
            ...
            <ul className="px-4 mb-4">
                ...
                <li><a href="https://instagram.com/myknlife"><i className="fa fa-instagram text-white"/> instagram</a>
                </li>
